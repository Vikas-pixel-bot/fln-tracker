  ...
  return (
    <div className="hidden sm:flex sm:items-center sm:gap-6">
      ...
      <div className="group relative py-2">
        <Link href={userRole ? "/dashboard" : "/dashboards"} className="text-gray-500 dark:text-gray-300 hover:text-amber-600 dark:hover:text-amber-400 text-sm font-medium transition-colors">
          {t('Dashboards')}
        </Link>
        <NavTooltip 
          title="Dashboards" 
